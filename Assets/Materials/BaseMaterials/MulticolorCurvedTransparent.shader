...
Shader "CustomMaterialCurvedTransparent" {
   Properties {
   ...
   SubShader {
      ...
      Pass {
            ...
            Blend One One  
            Offset 0, -1                          // Additively blend this pass with the previous one(s). This pass gets run once per pixel light.
            ZWrite Off
            CGPROGRAM
         #pragma vertex vert approxview
         #pragma fragment frag 
         ...
         #pragma fragmentoption ARB_precision_hint_fastest
         #pragma fragmentoption ARB_fog_linear
         #pragma glsl_no_auto_normalization                    // This line tells Unity to compile this pass for forward add, giving attenuation information for the light.
